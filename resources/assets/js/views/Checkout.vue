...
<script>
    export default {
        ...
        beforeMount() {
            ...
            if (localStorage.getItem('laradashb.jwt') != null) {
                this.user = JSON.parse(localStorage.getItem('laradashb.user'))
                axios.defaults.headers.common['Content-Type'] = 'application/json'
                axios.defaults.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('laradashb.jwt')
            }
        },
        methods : {
            login() {
